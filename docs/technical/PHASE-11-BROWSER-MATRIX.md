...
**NOT RUN — execution belongs to Slice 11.3 and packaged revalidation to
Slices 11.5/11.6.**
...
| B11-015 | Blackout, Show/Hide, fullscreen | 1920 x 1080 | NOT RUN | NOT RUN | Explicit state, safe content, capability/failure feedback |
...
| B11-021 | Indonesian UI and accessible copy | All targets | NOT RUN | NOT RUN | Complete copy, correct meaning, no clipping |
