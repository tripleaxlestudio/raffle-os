...
export function ProductionDashboardPage() {
  ...
  const actions = <div className="production-dashboard__secondary-actions"><ButtonLink icon={<Icon name="Upload" />} variant="secondary" to="/participants">Import Participants</ButtonLink><ButtonLink icon={<Icon name="SlidersHorizontal" />} variant="secondary" to="/draw/setup">Draw Setup</ButtonLink></div>
