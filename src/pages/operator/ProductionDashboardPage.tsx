...
export function ProductionDashboardPage() {
  ...
  return <section aria-labelledby="dashboard-title" className="dashboard">
    ...
    <p><ButtonLink variant="secondary" to="/events">Manage Events</ButtonLink> <ButtonLink variant="secondary" to="/prize-categories">Manage PrizeCategories</ButtonLink> <ButtonLink variant="secondary" to="/participants">Import Participants</ButtonLink></p>
