...
export function DrawRunPage() {
  ...
  return <section aria-labelledby="draw-run-title" className="draw-setup draw-run-production">
    ...
    <ConfirmationDialog headerIcon={<Icon name="RefreshCw" />} headerIconTone="warning" open={resetConfirmationOpen} onCancel={() => setResetConfirmationOpen(false)} onConfirm={() => { void resetPractice() }} title="Reset this rehearsal?" confirmLabel="Reset rehearsal" consequence="Practice winners and presentation progress will be cleared. No official results will be affected." tone="warning" />
     </div>
  </section>
}
