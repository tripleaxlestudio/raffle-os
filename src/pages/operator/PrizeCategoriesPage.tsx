...
export function PrizeCategoriesPage() {
  ...
  return <section className="prize-categories-page" aria-labelledby="categories-title"><div className={ui('page-header')}><div className={ui('page-header__copy')}><p className={ui('page-header__eyebrow')}>Pengaturan produksi</p><h1 id="categories-title">Kategori Hadiah</h1><p className={ui('page-header__description')}>Kelola kategori hadiah untuk {selectedEvent.name}.</p><p className="prize-categories-page__info">Perubahan hadiah berlaku untuk undian berikutnya. Record undian yang sudah ada tidak berubah.</p></div></div>
    ...
    <div className="prize-categories-page__layout">
      <Card padding="md" tone="raised" className="prize-categories-page__form-card"><div className="prize-categories-page__card-heading"><div><p className="prize-categories-page__eyebrow">{editing === null ? 'Kategori hadiah baru' : 'Edit record'}</p><h2>{editing === null ? 'Buat Kategori Hadiah' : 'Edit Kategori Hadiah'}</h2></div></div>
      ...
      <Card padding="md" tone="raised" className="prize-categories-page__list-card"><div className="prize-categories-page__card-heading"><div><p className="prize-categories-page__eyebrow">{items.length === 0 ? 'Pengaturan hadiah' : 'Hadiah yang sudah diatur'}</p><h2>Kategori Hadiah</h2></div><span className="prize-categories-page__record-count">{items.length} kategori</span></div>
