...
import { getAudienceScenarioFixture, resolveAudienceScenarioQuery } from '../../prototype/scenario-query.ts'
import { BlackoutStage, CountdownStage, DisconnectedStage, RollingStage, StandbyStage, WinnerStage } from '../../ui/audience/index.ts'

export function AudiencePrototypePage() {
  const [searchParams] = useSearchParams()
  const scenario = getAudienceScenarioFixture(resolveAudienceScenarioQuery(searchParams))
  switch (scenario.state) {
    ...
    case 'blackout': return <BlackoutStage />
    case 'disconnected': return <DisconnectedStage scenario={scenario} />
  }
}
